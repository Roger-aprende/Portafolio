    ...
    return(
        <article className='about-me'>
            <header className='about-me__header'>
                ...
                <img src={`../../src/assets/img/${who_I}`} alt=""  className='about-me__I'/>
                ...
                <div className="about-me__memories">
                    <img src={`../../src/assets/img/${memo_1}`} alt="hola" className="box1"/>
                    <img src={`../../src/assets/img/${memo_2}`} alt="hola" className="box2"/>
                    <img src={`../../src/assets/img/${memo_3}`} alt="hola" className="box3"/>
                </div>
